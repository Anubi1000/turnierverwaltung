...
import type { ItemListItemRaw } from "@/utils/types.ts";
...
const { items } = defineProps<{
  isLoading: boolean;
  isError: boolean;
  items: ItemListItemRaw[] | undefined;
  selectedItem: ItemListItemRaw | undefined;
}>();

const emit = defineEmits<{
  (e: "itemClick", item: ItemListItemRaw): void;
}>();
